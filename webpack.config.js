...
function webpackConfig() {
  ...
  config.plugins = [
    ...
    new ExtractTextPlugin( {filename: 'style-[hash:7].css',
      disable: false
      // allChunks: true
    } ),
    ...
    new HtmlWebpackPlugin( {
      ...
      favicon: path.join( PATHS.src, 'assets/images/favicon.ico' )
      // chunks: ['app', 'vendor']
    } )
  ];
    ...
    config.module.loaders.push([
      {
        ...
        loader: ExtractTextPlugin.extract({
          ...
          loader: 'css?sourceMap!postcss!sass?sourceMap=true&sourceMapContents=true&outputStyle=expanded&' +
